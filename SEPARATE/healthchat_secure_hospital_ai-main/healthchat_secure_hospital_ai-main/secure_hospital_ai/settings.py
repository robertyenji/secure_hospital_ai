...
# CSRF (who can SUBMIT forms / login)
CSRF_TRUSTED_ORIGINS = os.getenv(
    "CSRF_TRUSTED_ORIGINS",
    "https://healthchat.syncnative.com,"
    "https://healthchat.robertyenji.com,"
    "https://healthchat-secure-hospital-ai.fly.dev,"
    "http://localhost:8000,"
    "http://127.0.0.1:8000"
).split(",")

ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "localhost,127.0.0.1,.syncnative.com").split(",")
...
STATIC_URL = '/static/'
# Use 'static' directory for Fly.io statics configuration
